...
~/big_space/NAMEIII_v6_5_lotusFromJasminServer_ClareTest/NAMEIII_v6_5/Executables_Linux/${NAMEEXE} daily_run_Eth20161201.txt 
echo -e '... done\n'

# Set the NAME output directory.

WORKDIR="${TESTDIR}/Output_Dec2016"
...
echo -e 'Generating python graphics for NAME run based on  met data ...'
